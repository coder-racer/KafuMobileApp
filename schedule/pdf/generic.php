...
class NameObject extends Object1
{
    ...
    static function read_from_stream($stream)
    {
...
class DictionaryObject extends Object1
{
    ...
    static function read_from_stream($stream, $pdf)
    {
        $tmp = fread($stream, 2);
        if ($tmp != '<<') {
...
class NullObject extends Object1
{
...
class BooleanObject extends Object1
{
...
class ListObject extends Object1
{
    static function read_from_stream($stream, $pdf)
    {
        $arr = array();
...
class IndirectObject extends Object1
{
    function __construct($idnum, $generation, $pdf)
    {
        $this->idnum = $idnum;
...
class NumberObject extends Object1
{
    function __construct($value)
    {
        $this->value = $value;
...
class StreamObject extends Object1
{
