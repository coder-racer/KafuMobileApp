...
class SafeMySQL
{
	...
	function __construct($opt = array(), $admin=0)
	{
	 ...
	 * Example:
	 *
	 * $order = $db->whitelists($_GET['order'], array('name','price'));
	 * $dir   = $db->whitelists($_GET['dir'],   array('ASC','DESC'));
	 * if (!$order || !dir) {
	 ...
	 */
	public function whitelists($input,$allowed,$default=FALSE)
	{
